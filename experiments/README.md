...
```bash
/reuse/experiments $ reuse -t 3600 -d ReuSE_TEST ../benchmarks/grep/3.10/obj-llvm/src/grep.bc ../benchmarks/grep/3.10/obj-gcov/src/grep
```
...
```
/reuse/experiments$ python3 report_bugs.py --program grep ReuSE
```
...
```
/reuse/experiments$ python3 report_bugs.py --program grep ReuSE_TEST1 ReuSE_TEST2 ...
```


### Options of Reporting Programs
+ /experiments/calculate_coverage.py
```
