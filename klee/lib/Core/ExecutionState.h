...
public:
  ...
  std::vector<std::string> visitedLines;
  std::vector<ref<Expr>> forkedConstraints;
  std::string lastVisitedLine = "";
  ...
  /// @brief Deterministic creation order across forks.
  /// 0 means "unset"; assign on first use in Executor when forking.
